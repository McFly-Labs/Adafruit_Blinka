...
# For the pin mapping, check out the CPU datasheet (Preview here -https://www.nxp.com/docs/en/preview/PREVIEW_IMX8MPIEC.pdf ,
...
# I2C 2 - CSI 1
I2C2_SCL = Pin((5, 16))  # GPIO5_IO16
I2C2_SDA = Pin((5, 17))  # GPIO5_IO17

# I2C 3 - CSI 2
I2C3_SCL = Pin((5, 18))  # GPIO5_IO18
I2C3_SDA = Pin((5, 19))  # GPIO5_IO19

# I2C 4 - RTC
I2C4_SCL = Pin((5, 20))  # GPIO5_IO20
I2C4_SDA = Pin((5, 21))  # GPIO5_IO21
...
GPIO5_IO0 = Pin((5, 0))  # GPIO5.IO[0]
GPIO5_IO1 = Pin((5, 1))  # gpio5.IO[1]
